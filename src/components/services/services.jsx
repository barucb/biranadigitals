...
<p className="lg:mt-36 pt-32 pb-6 px-5 text-center text-[#fc7405] text-5xl font-bold">
   Our Services
         ...
         <div className="flex">
             ...
             <img className="w-48 py-5 mx-auto" src="/brand.png" alt="Branding" />
             ...
             <div className="flex ">
                 ...
                 <div className="py-2  mx-2 md:mt-3 ">
             <img className="w-48 py-5 mx-auto" src="/social-media.png" alt="social media marketing" />
             ...
             <div className="flex">
                 ...
                 <div className="py-2 mx-2 md:mt-3 ">
                 <img className="w-48 py-5 mx-auto" src="/coding.png" alt="Web and app development" />
...
Transform your ideas into digital experiences. Our Web & App Development services create seamless, responsive, and user-friendly solutions tailored to your needs.
             ...
             <div className="flex">
                 ...
                 <div className="py-2 mx-2 md:mt-3">
                 <img className="w-48 py-5 mx-auto" src="/seo.png" alt="SEO" />
...
Boost your online visibility and rankings with our SEO services. We optimize your digital presence, making it easier for your audience to find you.
                 ...
                 <div className="py-2 mx-2 md:mt-3 ">
                 <img className="w-48 py-5 mx-auto" src="/consulting.png" alt="Consultancy" />
             ...
             <div className="flex">
                 ...
                 <div className="py-2 mx-2 md:mt-3 ">
                 <img className="w-48 py-5 mx-auto" src="/influencer.png" alt="Influencer Marketing" />
