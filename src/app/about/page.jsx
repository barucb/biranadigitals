    ...
    <>
      <div className='pt-32 pb-16 lg:py-48 lg:pt-72 flex flex-col' >
        <div className=' lg:ml-32  flex flex-col lg:flex-row lg:text-start'>
          ...
          <div className='w-full lg:w-[40%] lg:pl-8'>
            ...
            <img src="/birana-experts.png" className='w-full  pt-5 lg:pt-10' />
          </div>
        ...
        <div className=' lg:pt-36 lg:ml-32  flex flex-col lg:flex-row '>
          <div className='w-full order-2  lg:w-[40%] lg:pr-8'>
            ...
            <img src="/birana-innovators.png" className='w-full  pt-5 lg:pt-10' />
          </div>
          <div className='lg:w-[50%] order-1 lg:order-2 pt-16 lg:pl-24 xl:pl-48 lg:pt-16 '>
            ...
            <p className='md:text-3xl text-xl pt-5 '>
              ...
              <p className='pt-3 pb-12'>
                ...
                Whether it's crafting compelling content, designing eye-catching visuals,
      ...
      <div className='py-24 lg:pt-80'>
        ...
        <div className='md:text-3xl xl:px-72 text-xl px-3 lg:px-48 pt-5 '>
          ...
          <p className='pb-16 pt-2'>
            Your success is our success. We are committed to delivering measurable results. Whether it's increased website traffic, higher conversion rates, or enhanced brand visibility, we are with you every step of the way.
          </p>
          <b>
            Transparent Collaboration
          </b>
          <p className='pb-8 pt-2'>
            We believe in transparent communication and collaboration. Throughout the project, you'll have a dedicated team working closely with you, keeping you informed and involved.
          </p>
        </div>
      </div>
      <div className='pb-24 lg:pt-48'>
        ...
        <div className='md:text-3xl text-xl px-3 lg:px-64 pt-5 '>
          ...
          <p className='pb-8  pt-2'>
            ...
            aiming for digital transformation, we're here to help.
...
// <div className='w-full lg:ml-32 justify-center pt-12 lg:pt-0  flex lg:w-[80%]  '>
// <div className='flex py-5 px-2 lg:pl-10 items-center flex-col'>
//   <img src="/birana-experts.png" className='w-full ' />
//   <p className='lg:text-4xl order-first lg:order-2 text-2xl pt-5 lg:pt-24 '>
//     <b>
//       Innovators at Heart
//     </b>
//     <p className=' md:text-3xl text-xl pt-3 pb-12'>
//       Innovation is in our DNA. We stay at the forefront of digital trends,
//       constantly exploring new possibilities to elevate your online presence.
//       Whether it's crafting compelling content, designing eye-catching visuals,
//       or developing robust websites, we love what we do.
...
//   <div>
//     <button className='p-2 px-16 text-xl hover:text-white mt-6 rounded-lg bg-[#fc7405] text-black' >
//       Submit
//     </button>
//   </div>
// </div>
